"""Reusable page widgets for the scoutmini_display dashboard app."""

from scoutmini_display.pages.camera_page import CameraPage
from scoutmini_display.pages.counter_page import CounterPage
from scoutmini_display.pages.go_to_room_page import GoToRoomPage
