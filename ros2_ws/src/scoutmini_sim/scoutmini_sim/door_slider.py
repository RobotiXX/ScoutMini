...
class DoorSlider(Node):
    def __init__(self):
        ...
        self.declare_parameter('model_name', 'door_1')
        self.declare_parameter('hinge_x', 23.52884)
        self.declare_parameter('hinge_y', 7.0)
        self.declare_parameter('hinge_z', 0.0)
        self.declare_parameter('closed_yaw', 2.55)
