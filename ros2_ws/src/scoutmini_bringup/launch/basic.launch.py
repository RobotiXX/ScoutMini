...
def generate_launch_description():
    ...
    scout_description_pkg = get_package_share_directory(
        'scoutmini_description'
    )
    streaming_pkg = get_package_share_directory('scoutmini_streaming')
    ...
    return LaunchDescription([
        ...
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(
                os.path.join(scout_pkg, 'launch', 'scout_mini_base.launch.py')
            ),
        ),
        ...
        IncludeLaunchDescription(
            ...
            launch_arguments={
                ...
                'publish_odom_topic': LaunchConfiguration(
                    'publish_odom_topic'
                ),
        ...
        # Publish the already-running ZED ROS image as RTSP.
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(
                os.path.join(streaming_pkg, 'launch', 'image2rtsp.launch.py')
            ),
        ),
