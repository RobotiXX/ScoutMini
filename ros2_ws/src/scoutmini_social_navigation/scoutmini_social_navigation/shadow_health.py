...
class ShadowHealth:
    ...
    def observe_action(self, active: bool) -> None:
    ...
    def evaluate(
        ...
        output_age = self._age(now_sec, self.last_output_sec)
        ...
        if self.people_messages == 0 or self.output_messages == 0:
